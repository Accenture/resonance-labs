(function () {
  var groups = document.querySelectorAll('.rlb-variant-selector__options[role="radiogroup"]');
  var liveRegion = document.querySelector('.rlb-variant-selector__live-region');
