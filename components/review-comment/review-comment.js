(function () {
  var liveRegion = document.querySelector('.review-comment__live-region');
  if (!liveRegion) return;

  // Helpful buttons — increment count on click
  var helpfulBtns = document.querySelectorAll('.review-comment__helpful-btn');
  helpfulBtns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      var countEl = btn.querySelector('.review-comment__helpful-count');
      ...
      var article = btn.closest('.review-comment');
  ...
  var reportBtns = document.querySelectorAll('.review-comment__report-btn');
