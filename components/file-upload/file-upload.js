(function () {
  ...
  function createFileItem(entry) {
    ...
    icon.setAttribute("class", "file-upload-list__icon");
    ...
    info.className = "file-upload-list__info";

    var nameSpan = document.createElement("span");
    nameSpan.className = "file-upload-list__name";
    nameSpan.textContent = entry.name;

    var meta = document.createElement("span");
    meta.className = "file-upload-list__meta";

    var sizeSpan = document.createElement("span");
    sizeSpan.className = "file-upload-list__size";
    ...
    progressWrap.className = "file-upload-list__progress";
    ...
    progressBar.className = "file-upload-list__progress-bar";
    ...
    removeBtn.className = "file-upload-list__remove";
  ...
  function simulateUpload(entry) {
    ...
    var progressWrap = li.querySelector(".file-upload-list__progress");
    var progressBar = li.querySelector(".file-upload-list__progress-bar");
    ...
    var interval = setInterval(function () {
      ...
      if (progress >= 100) {
        ...
        progressBar.classList.add("file-upload-list__progress-bar--complete");
  ...
  function removeFile(id) {
    ...
    if (nextSibling) {
      focusTarget = nextSibling.querySelector(".file-upload-list__remove");
    } else if (prevSibling) {
      focusTarget = prevSibling.querySelector(".file-upload-list__remove");
    } else {
  ...
  dropzone.addEventListener("dragenter", function (e) {
    e.preventDefault();
    e.stopPropagation();
    dropzone.classList.add("file-upload-dropzone--drag-over");
  });
  ...
  dropzone.addEventListener("dragleave", function (e) {
    ...
    if (!dropzone.contains(e.relatedTarget)) {
      dropzone.classList.remove("file-upload-dropzone--drag-over");
    }
  });
  ...
  dropzone.addEventListener("click", function (e) {
    ...
    if (e.target === fileInput || e.target.closest(".file-upload-list__remove")) {
      return;
    }
    fileInput.click();
  });
